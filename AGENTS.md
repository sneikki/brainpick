...
<!-- brainpick:begin report (hash:435f0fc8) -->
...
- Counts: 148 docs · 1005 links · 19 tags · 0 orphans · 0 ghosts
- Tiers: t1 fresh · t2 fresh · t3 fresh
- Top hubs (in/out):
  - Configuration reference (reference-config.md) — 37/35
  - Architecture decision records (reference-adr.md) — 26/26
  - Henxels contract reference (reference-henxels.md) — 22/18
  - CLI reference (reference-cli.md) — 19/18
  - Spec reference (reference-spec.md) — 18/19
- Orphans:
  - (none)
- Top ghosts:
  - (none)
- Top similarity gaps:
  - reference/spec/similarity-gaps.md ↔ similarity-gap-detector.md — 0.834
  - agent-integrations.md ↔ reference-cli.md — 0.788
  - artifact-spec.md ↔ reference/spec/manifest.md — 0.779
  - artifact-spec.md ↔ brain-template.md — 0.775
- Bundle root: docs
